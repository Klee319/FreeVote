...
export async function POST(request: NextRequest) {
  try {
    ...
    console.log('[API Proxy] Forwarding anonymous registration to backend:', {
      url: `${BACKEND_API_URL}/api/auth/anonymous-register`,
      hasBody: !!body,
    ...
    console.log('[API Proxy] Backend registration response:', {

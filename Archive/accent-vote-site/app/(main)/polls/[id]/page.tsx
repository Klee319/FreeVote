    ...
    const fetchPoll = async () => {
      try {
        ...
        if (data.success) {
          ...
          const formattedPoll: PollDetail = {
            id: pollData.id,
            ...
            startDate: pollData.createdAt,
            endDate: pollData.deadline,
            totalVotes: pollData.totalVotes || 0,
            uniqueVoters: pollData.totalVotes || 0,
            ...
            options: pollData.options.map((option: string, index: number) => ({
              ...
              text: option,
              order: index,
              voteCount: pollData.optionStats?.[index]?.count || 0,
              percentage: pollData.optionStats?.[index]?.percentage || 0,
            })),
            canVote: pollData.status === 'active',
            hasVoted: false,
            tags: pollData.shareHashtags ? pollData.shareHashtags.split(',') : [],
          };

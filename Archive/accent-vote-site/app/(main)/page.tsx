      ...
      <section className="bg-gradient-to-b from-primary-50 to-white py-12 md:py-20">
        <div className="container mx-auto px-4">
          <div className="text-center mb-8">
            <h1 className="text-4xl md:text-5xl font-black text-gray-900 mb-4" style={{ fontWeight: 900 }}>
              <span className="text-primary-600 font-black" style={{ fontWeight: 900 }}>気になる投票所</span>へようこそ
            </h1>

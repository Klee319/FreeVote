...
/**
 * ランキングAPIプロキシ
 * フロントエンドからのランキングリクエストをバックエンドにプロキシする
 */
export async function GET(request: NextRequest) {
  try {
    ...
    console.log('[API Proxy] Forwarding ranking request to backend:', {
    ...
    console.error('[API Proxy] Error forwarding ranking request:', error);
